...
data_morta_able <- read_excel("I:/_restricted area/RM/I. Risk Management/1.7 - Modèle interne/Cluster 8/PREDICA/Vérification du provisionnement/Verification de la PRC via calcul des lois/Data/Donnée pour les lois/Data loi de mortalité/data_morta_able.xlsx")
t <- data_morta_able
...
LCfit <- fit(LC, Dxt= Dxt_homme_prosp[41:88,], Ext=Ext_homme_prosp[41:88,],ages=40:87 ,years=2000:2016)
...
persp3d(41:86,2003:2016,(Mmodele[1:46,]),theta=-20,phi=20,xlab='age' ,ylab='annee',zlab='ln(mu)' ,ticktype = "detailed",border = "black",col = "white", texture = system.file("textures/world.png", package = "rgl"),  specular = "black" )
